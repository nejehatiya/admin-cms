 ...
 */
final class Version20240320021222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_modals (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, modele_id INT NOT NULL, content_modele_post LONGTEXT DEFAULT NULL, INDEX IDX_D3FD7CB04B89032C (post_id), INDEX IDX_D3FD7CB0AC14B70A (modele_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
