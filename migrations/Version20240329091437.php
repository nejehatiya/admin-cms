 ...
 */
final class Version20240329091437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modeles_post ADD image_preview_id INT DEFAULT NULL, DROP image_preview, DROP used_in');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modeles_post ADD image_preview VARCHAR(255) DEFAULT NULL, ADD used_in LONGTEXT DEFAULT NULL, DROP image_preview_id');
    }
}
