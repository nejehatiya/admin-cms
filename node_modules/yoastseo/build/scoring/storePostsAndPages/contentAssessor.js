...
} = _yoastseo.assessments.readability;
...
const StorePostsAndPagesContentAssessor = function (researcher, options = {}) {
  ...
  this._assessments = [new SubheadingDistributionTooLongAssessment({
...
(0, _util.inherits)(StorePostsAndPagesContentAssessor, _yoastseo.ContentAssessor);
var _default = exports.default = StorePostsAndPagesContentAssessor;
