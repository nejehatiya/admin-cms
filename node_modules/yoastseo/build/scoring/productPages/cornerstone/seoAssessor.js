...
const ProductCornerstoneSEOAssessor = function (researcher, options) {
  _yoastseo.Assessor.call(this, researcher, options);
  this.type = "productCornerstoneSEOAssessor";
  this._assessments = [new IntroductionKeywordAssessment({
  ...
  }, true), new KeyphraseDensityAssessment({
  ...
  }, true), new SlugKeywordAssessment({
    scores: {
      okay: 3
    },
  ...
  }, options.countVideos), new ImageKeyphraseAssessment({
    scores: {
      withAltNonKeyword: 3,
      withAlt: 3,
      noAlt: 3
...
(0, _util.inherits)(ProductCornerstoneSEOAssessor, _yoastseo.SeoAssessor);
var _default = exports.default = ProductCornerstoneSEOAssessor;
