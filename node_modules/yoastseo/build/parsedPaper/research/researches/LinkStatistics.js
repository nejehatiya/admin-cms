...
var _Research = _interopRequireDefault(require("./Research"));
 ...
 */
class LinkStatistics extends _Research.default {
  /**
  ...
  _whichTarget(linkElement, domain) {
    ...
    const url = _url.default.parse(link);
  ...
  calculateFor(node, metadata) {
    ...
    const url = _url.default.parse(permalink);
...
var _default = exports.default = LinkStatistics;
//# sourceMappingURL=LinkStatistics.js.map