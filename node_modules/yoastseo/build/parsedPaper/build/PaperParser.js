...
class PaperParser {
  ...
  constructor(treeBuilder) {
    this._parsedPaper = new _ParsedPaper.default();
  ...
  runMetaDataModifiers(metaData, paper) {
    ...
    (0, _lodash.forEach)(this._metaDataModifiers, (modifierFunction, modifierName) => {
      try {
...
var _default = exports.default = PaperParser;
