...
var _LeafNode = _interopRequireDefault(require("../../../structure/tree/nodes/LeafNode"));
...
class HTMLTreeConverter {
  ...
  _addLeafNodeContent(contentToAdd, add, parent, location) {
    if (parent instanceof _LeafNode.default) {
  ...
  _leafNodeAncestor(element) {
    ...
    if (element instanceof _LeafNode.default) {
      return parent;
    }
    return this._leafNodeAncestor(parent);
  }
}
var _default = exports.default = HTMLTreeConverter;
