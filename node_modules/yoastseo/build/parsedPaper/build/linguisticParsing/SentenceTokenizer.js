...
class SentenceTokenizer {
  ...
  getSentencesFromTokens(tokenArray) {
    ...
    let currentSentence = new _Sentence.default("", 0, 0),
      nextSentenceStart;
    tokenArray.forEach((token, i) => {
      ...
      switch (token.type) {
        ...
        case "sentence-delimiter":
          currentSentence.appendText(token.src);
          if (!(0, _lodash.isUndefined)(nextToken) && "block-end" !== nextToken.type && "sentence-delimiter" !== nextToken.type) {
            tokenSentences.push(currentSentence);
            currentSentence = new _Sentence.default("");
          }
          break;
        case "full-stop":
          currentSentence.appendText(token.src);
