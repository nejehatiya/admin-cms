...
function createForms(word, morphologyData) {
  ...
  let allEndings = (0, _lodash.uniq)((0, _lodash.flatten)(paradigmEndingsGroups));
  ...
  return (0, _lodash.uniq)((0, _lodash.flatten)(forms));
}
 ...
 * @returns {Array} The array of created forms.
 */
function _default(word, morphologyData) {
