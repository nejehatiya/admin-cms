 ...
 */
class JapaneseSentenceTokenizer extends _SentenceTokenizer.default {
  /**
   * Constructor
   * @constructor
   */
  ...
  isNumber(character) {
    ...
    // Circled ideograph.
    /^[\u3280-\u3289]+$/i];
    return !(0, _lodash.isNaN)(parseInt(character, 10)) || japaneseNumbers.some(numberRange => numberRange.test(character));
  }
...
exports.default = JapaneseSentenceTokenizer;
