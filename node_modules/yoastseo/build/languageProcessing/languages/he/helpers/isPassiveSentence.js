...
function isPassiveSentence(sentence) {
  ...
  for (const word of words) {
    ...
    const nifalPassive = checkHebrewVerbRootsList(word, _regularRootsNifal.default, nifalAffixes);
    if (nifalPassive) {
      return true;
    }
    ...
    const pualPassive = _regularRootsPual.default.some(root => pualAffixes.some(function (affixes) {
    ...
    const hufalPassive = checkHebrewVerbRootsList(word, _regularRootsHufal.default, hufalAffixes);
    if (hufalPassive) {
      return true;
    }
  }
