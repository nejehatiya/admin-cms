...
var _exceptionsParticiplesActive = _interopRequireDefault(require("../../config/internal/exceptionsParticiplesActive"));
var _passiveVoiceRegex = _interopRequireDefault(require("../../config/internal/passiveVoiceRegex"));
...
function detectAndStemRegularParticiple(morphologyDataVerbs, word) {
  if ((0, _passiveVoiceRegex.default)(word).length > 0 || _exceptionsParticiplesActive.default.includes(word)) {
    return "";
  }
