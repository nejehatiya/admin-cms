...
const options = {
  ...
  regexes: {
    auxiliaryRegex: createRegexFromArray(_auxiliaries.default.allAuxiliaries),
    stopwordRegex: createRegexFromArray(_stopWords.default)
  }
};
 ...
 */
function getHungarianClauses(sentence) {
